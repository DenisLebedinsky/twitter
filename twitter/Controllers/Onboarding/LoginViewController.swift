...
class LoginViewController: UIViewController {
    private var viewModel = AuthinticationViewViewModel()
    ...
    override func viewDidLoad() {
        ...
        loginButton.addTarget(self, action: #selector(didTaoLogin), for: .touchUpInside)
        
        configureConstraints()
        bindViews()
    }
    
    @objc private func didTaoLogin(){
        viewModel.loginUser()
    }
